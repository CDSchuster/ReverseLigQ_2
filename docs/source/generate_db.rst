...
- :mod:`generate_db.LigandPfamDataRequest`: This module contains functions to request PDB IDs that are bound to molecules, request their ligands’ data (SMILEs included) and the Pfam domains in those PDBs.
...
generate\_db.LigandPfamDataRequest module
-----------------------------------------

.. automodule:: generate_db.LigandPfamDataRequest
   :members:
   :show-inheritance:
   :undoc-members:

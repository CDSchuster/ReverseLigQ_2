...
def run_database_generation(min_actives, max_actives, threshold, max_decoys):
    #generate_pdb_db.main()
    log.info("Starting PDB smiles pairs dataset generation")
    pdb_smiles_dataset = generate_smiles_pairs_dataset(min_actives, max_actives, threshold, max_decoys)